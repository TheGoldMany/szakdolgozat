  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md text-center">
        ...
        <h1 className="mt-2 text-2xl font-bold text-gray-900">Ez az oldal elkóborolt</h1>
        <p className="mt-2 text-sm leading-relaxed text-gray-500">
          A keresett oldal nem található. Lehet, hogy elköltözött, vagy soha nem is létezett.
        </p>
        <div className="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          >
            <Home className="h-4 w-4" /> Vissza a főoldalra
          </Link>
          <Link
            href="/animals"
          ...
          >
            <Search className="h-4 w-4" /> Állatok böngészése
          </Link>
        </div>
      </div>
    </div>
