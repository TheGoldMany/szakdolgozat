...
export function CookieBanner() {
  ...
  return (
    <div
      role="dialog"
      aria-label={t("title")}
      className="animate-sheet-up fixed bottom-[calc(3.5rem+env(safe-area-inset-bottom))] left-0 right-0 z-50 border-t border-gray-200 bg-white/95 shadow-2xl backdrop-blur-sm sm:left-4 sm:right-auto sm:max-w-sm sm:rounded-2xl sm:border md:bottom-4"
    >
